...
3. In the workspace, create a new project from a Github repository using this link: [https://github.com/mclevey/3040-2025-assignment-1-posit.git](https://github.com/mclevey/3040-2025-assignment-1-posit.git).
